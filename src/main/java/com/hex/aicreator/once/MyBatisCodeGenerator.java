package com.hex.aicreator.once;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig().setBasePackage("com.hex.aicreator.ZZZZGENZZZZZZ");
        ...
        // 设置文档注释
        globalConfig.getJavadocConfig().setAuthor("<a href=\"https://github.com/ApprenticeDyc\">DYC666</a>")
                .setSince("");
        return globalConfig;
    }
}